...
SGL_PY_EXPORT(device_reflection)
{
    ...
    program_layout //
        ...
        .def("find_trace_program_schema", &ProgramLayout::find_trace_program_schema, "name"_a)
    ...
    nb::class_<TraceProgramHitGroupInfo>(m, "TraceProgramHitGroupInfo")
        .def_ro("function_index", &TraceProgramHitGroupInfo::function_index)
        .def_ro("is_linked", &TraceProgramHitGroupInfo::is_linked)
        ...
        .def_ro("record_type_layout", &TraceProgramHitGroupInfo::record_type_layout)
        ...
        .def_ro("closest_hit_entry_point_name", &TraceProgramHitGroupInfo::closest_hit_entry_point_name)
    ...
    nb::class_<TraceProgramMissShaderInfo>(m, "TraceProgramMissShaderInfo")
        .def_ro("function_index", &TraceProgramMissShaderInfo::function_index)
        .def_ro("is_linked", &TraceProgramMissShaderInfo::is_linked)
        .def_ro("type", &TraceProgramMissShaderInfo::type)
        .def_ro("type_name", &TraceProgramMissShaderInfo::type_name)
        .def_ro("context_type", &TraceProgramMissShaderInfo::context_type)
        .def_ro("record_type", &TraceProgramMissShaderInfo::record_type)
        .def_ro("record_type_layout", &TraceProgramMissShaderInfo::record_type_layout)
        .def_ro("miss", &TraceProgramMissShaderInfo::miss);

    nb::class_<TraceProgramCallableShaderInfo>(m, "TraceProgramCallableShaderInfo")
        .def_ro("function_index", &TraceProgramCallableShaderInfo::function_index)
        .def_ro("is_linked", &TraceProgramCallableShaderInfo::is_linked)
        .def_ro("type", &TraceProgramCallableShaderInfo::type)
        .def_ro("type_name", &TraceProgramCallableShaderInfo::type_name)
        .def_ro("context_type", &TraceProgramCallableShaderInfo::context_type)
        .def_ro("record_type", &TraceProgramCallableShaderInfo::record_type)
        .def_ro("record_type_layout", &TraceProgramCallableShaderInfo::record_type_layout)
        .def_ro("data_type", &TraceProgramCallableShaderInfo::data_type)
        .def_ro("callable", &TraceProgramCallableShaderInfo::callable);

    nb::class_<TraceProgramPayloadInfo>(m, "TraceProgramPayloadInfo")
        .def_ro("type", &TraceProgramPayloadInfo::type)
        .def_ro("type_name", &TraceProgramPayloadInfo::type_name)
        .def_ro("type_layout", &TraceProgramPayloadInfo::type_layout)
        .def_ro("native_payload_size", &TraceProgramPayloadInfo::native_payload_size)
        .def_ro("hit_groups", &TraceProgramPayloadInfo::hit_groups)
        .def_ro("miss_shaders", &TraceProgramPayloadInfo::miss_shaders);

    nb::class_<TraceProgramSchemaInfo, Object>(m, "TraceProgramSchemaInfo")
        .def_prop_ro("is_valid", &TraceProgramSchemaInfo::is_valid)
        .def_ro("name", &TraceProgramSchemaInfo::name)
        .def_ro("type", &TraceProgramSchemaInfo::type)
        .def_ro("type_name", &TraceProgramSchemaInfo::type_name)
        .def_ro("trace_context_type", &TraceProgramSchemaInfo::trace_context_type)
        .def_ro("is_hit_group_section_open", &TraceProgramSchemaInfo::is_hit_group_section_open)
        .def_ro("is_miss_shader_section_open", &TraceProgramSchemaInfo::is_miss_shader_section_open)
        .def_ro("is_callable_shader_section_open", &TraceProgramSchemaInfo::is_callable_shader_section_open)
        .def_ro("hit_record_stride", &TraceProgramSchemaInfo::hit_record_stride)
        .def_ro("miss_record_stride", &TraceProgramSchemaInfo::miss_record_stride)
        .def_ro("callable_record_stride", &TraceProgramSchemaInfo::callable_record_stride)
        .def_ro("max_native_hit_attribute_size", &TraceProgramSchemaInfo::max_native_hit_attribute_size)
        .def_ro("metal_record_header_size", &TraceProgramSchemaInfo::metal_record_header_size)
        .def_prop_ro("max_native_payload_size", &TraceProgramSchemaInfo::max_native_payload_size)
        .def_ro("payloads", &TraceProgramSchemaInfo::payloads)
        .def_ro("callable_shaders", &TraceProgramSchemaInfo::callable_shaders);
